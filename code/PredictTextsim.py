...
if __name__ == "__main__":
    ...
    test_embedding = pickle.load(open('../checkpoint/recall/embedding.pkl', 'rb'))
    ...
    for _raw_word, _normalized_result in zip(train_data_df['text'], train_data_df['normalized_result']):
        ...
        dev_pair_dataset = []
        for index,_search_word in enumerate(
                [_results for _results in recall(j, 0.97) ]):
    ...
    # with open('../checkpoint/recall/embedding.pkl', "wb") as f:
